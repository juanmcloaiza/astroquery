...
Processed data downloaded from the ESO Archive are assigned a **Digital Object Identifier (DOI)**. The list of available DOIs can be browsed `here1 <https://archive.eso.org/wdb/wdb/doi/collections/query>`_.
